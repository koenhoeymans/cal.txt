...
class ConversionTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->inputFile = __DIR_ . DIRECTORY_SEPARATOR . 'sample_calendar.txt';
        $this->outputFile = sys_get_temp_dir() . DIRECTORY_SEPARATOR . 'sampe_calendar.ics';
    ...
    {
        $expected_content = file_get_content($this->outputFile);
